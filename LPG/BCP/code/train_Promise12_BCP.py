...
def patients_to_slices(dataset, patiens_num):
    ...
    if "MSC19" in dataset:
        ref_dict = {'5':77,'7': 110,'14': 219,'35': 530}
    else:
        print("Error")
    ...
    for _ in iterator:
        ...
        for _, sampled_batch in enumerate(trainloader):
            ...
            with torch.no_grad():
                ...
                plab_a = get_Promise12_masks(pre_a, nms=1)
            ...
            monitor_gpu_memory(iter_num, ema_model, volume_batch)
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./model/BCP/Promise12/Promise12_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/BCP/Promise12/Promise12_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    for snapshot_path in [pre_snapshot_path, self_snapshot_path]:
        if not os.path.exists(snapshot_path):
            os.makedirs(snapshot_path)
    shutil.copy('../code/Promise12_BCP_train.py', self_snapshot_path)
